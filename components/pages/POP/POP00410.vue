...
const { getComponentData } = usePageLoaderComponent(['POP00410'])

const ReturnInspection = useReturnInspectionStore()
const { ReturnListData } = storeToRefs(ReturnInspection)
...
const tableFields = computed(() => {
  return pageLoader.getTableData('POP00410', 'POP00410_GRD01001')
})

const perPage = ref(15)
const { currentPage, paginatedData, isLastPage, resetPage } = usePagination(ReturnListData, perPage.value);
