...
watch(() => transactionType.value, (value) => {
  if (value) {
    ...
    switch (value.value) {
      case '0010':
        categoryOptions.value = commonData.getCsCategoryOrderOptions
        break
      case '0020':
        categoryOptions.value = commonData.getCsCategoryReturnOptions
        break
      case '0030':
        categoryOptions.value = commonData.getCsCategoryExchangeOptions
        break
      default:
      ...
      <div>
        ...
        <div class="grid grid-cols-4 space-x-6 mb-3">
          <FormGroup
            ...
            label-width="w-1/4"
            input-width="w-3/4"
            :label="getComponentData('OU040100_LBL03006', 'caption')"
          >
            <div class="flex items-center gap-x-3">
              <FormSelect
                v-model="transactionType"
                :options="commonData.getTransactionTypeAllOptions"
              />
              <FormSelect
                v-model="category"
