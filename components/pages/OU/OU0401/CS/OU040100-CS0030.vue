      ...
      <div>
        ...
        <div class="grid grid-cols-4 space-x-6 mb-3">
          <FormGroup
            ...
            label-width="w-1/4"
            input-width="w-3/4"
            :label="getComponentData('OU040100_LBL04006', 'caption')"
          >
            <FormSelect
              v-model="category"
              :options="commonData.getCsCategoryRepairOptions"
            />
          </FormGroup>
        ...
        <div class="grid grid-cols-4 space-x-6 items-center border-b mb-6 pb-3">
          ...
          <FormGroup
            :label="getComponentData('OU040100_LBL04012', 'caption')"
            label-id="OU040100_LBL04012"
            label-for="OU040100_TXT04007"
            horizontal
          >
            <FormTextInput
              id="OU040100_TXT04007"
          ...
          <div class="flex items-center gap-x-3">
            <FormCheckbox
              id="OU040100_CHK04002"
              v-model="chargeCustomer"
              :label="getComponentData('OU040100_LBL04013', 'caption')"
            />
