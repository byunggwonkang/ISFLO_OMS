    ...
    >
      <div class="grid grid-cols-5 mb-3">
        <p class="font-normal text-gray-700 text-sm uppercase">
          {{ getComponentData('OU040100_LBL02001', 'caption') }}
        </p>
      ...
      <div>
        ...
        <div class="grid grid-cols-4 space-x-6 mb-3">
          <FormGroup
            :label="getComponentData('OU040100_LBL02006', 'caption')"
            label-id="OU040100_LBL02006"
            label-for="OU040100_CMB02002"
            label-width="w-1/4"
            input-width="w-3/4"
            horizontal
          >
            <FormSelect
              id="OU040100_CMB02002"
              v-model="category"
              :options="commonData.getCsCategoryRegularOptions"
            />
          </FormGroup>
        ...
        <div class="grid grid-cols-5 space-x-6 items-center border-b mb-6 pb-3">
          <FormCheckbox
